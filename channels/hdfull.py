...
def do_downloadpage(url, post=None):
    ...
    data = httptools.downloadpage(url, post=post, headers={'Referer': 'https://hdfull.io', 'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:75.0) Gecko/20100101 Firefox/75.0'}).data
